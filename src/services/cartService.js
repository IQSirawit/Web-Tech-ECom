/**
 * cartService.js - Frontend cart management service
 * Handles cart operations using localStorage
 */

// Initialize cart from localStorage
const savedItems = (typeof localStorage !== 'undefined') ? JSON.parse(localStorage.getItem('cart_items')) || {} : {};
const cart = {
    items: savedItems,
    totalItems: Object.values(savedItems).reduce((acc, item) => acc + Number(item.quantity || 0), 0)
};

// Make cart globally accessible for checkout
